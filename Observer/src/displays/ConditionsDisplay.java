...
public class ConditionsDisplay implements Displayable , Observable {
    private int temp;
    private int humidity;
    private int pressure;
    private Subjectable weatherData;

    public ConditionsDisplay(Subjectable weatherData){
    ...
    public void display()
    {
        System.out.println("----- Conditions Displays : -----");
